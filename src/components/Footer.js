        ...
        <div className="footer-content">
            <div className="site-info">
                <div className="aboutText">
                    <p>An amateur foodie, avid traveler and design enthusiast, not really an influencer wannabe but just wanted a place to record all the amazing events in his life</p>
                    © Bruce Zha 2021
                </div>
                
                {/* 
                <div className="footerSocial">
                    <a href="https://instagram.com/ethan.justin" target="_blank" rel="noopener" title="Bruxw Instagram">
